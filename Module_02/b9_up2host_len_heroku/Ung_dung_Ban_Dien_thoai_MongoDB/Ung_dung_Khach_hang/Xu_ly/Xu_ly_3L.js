...
function Tao_The_hien_Dien_thoai(Dien_thoai, Th_Cha) {
    ...
    Th_Cha.appendChild(the_hien)
    var Chuoi_HTML = `<div class="card m-2 p-2" style="width: 17rem">
  <img class="card-img-top" src="https://dv-media-duc.herokuapp.com//${Dien_thoai.Ma_so}.png" alt="">
  <div class="card-body">
...
function Xuat_Thong_tin_Cua_hang(Cua_hang, Th_Cha) {
    ...
    Th_Cha.appendChild(The_hien)
    var noi_dung_HTML = `<img src="https://dv-media-duc.herokuapp.com/${Cua_hang.Ma_so}.png" class="img-fluid float-left" />
